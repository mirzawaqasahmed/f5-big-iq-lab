...
HOSTNAME=vBIGIP02.termmarc.com   # Hostname of BIGIP mgmt
SELF_IP_ADDR=10.1.10.2           # Self-IP Address of you BIGIP
VIRTUAL_IP=10.1.10.200           # Virtual address for traffic for swg, access reports
