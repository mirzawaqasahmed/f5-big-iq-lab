Lab2: Creating and Managing AFM Logging on BIG-IQ
--------------------------------------------------

Lab 2.1: Configure BIG-IQ Logging for AFM
******************************************
...
Lab 2.2: Create new Application Template Using Firewall objects
****************************************************************
...
2. Click the checkbox next to ``f5-afm-policy_36``
...
5. In the *Network Security* section, set the Enforced Firewall Policy to ``f5-afm-policy_36`` for both virtual servers.
...
Lab 2.2: Update Existing Application To Use New Application Template:
**********************************************************************
...
9. Verify that the Network Firewall policy listed in the Security Configuration summary pane lists ``f5-afm-policy_36`` as the firewall policy.
...
Lab 2.3: Monitoring Firewall Logging On BIG-IQ:
***********************************************
