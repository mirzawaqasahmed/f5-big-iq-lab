Lab 4.1: Configure High Availbility for BIG-IQ
----------------------------------------------
...
device to the secondary device every 30 seconds. If it ever becomes necessary, you can have the secondary peer take over management of the BIG-IP devices.
